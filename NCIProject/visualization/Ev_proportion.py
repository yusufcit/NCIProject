...
def evProportion():
    try:
        ...
        fig = px.scatter(df, x="total_cars_registered", y="ev_and_hv", color="county", size="ev_hv_proportion",
                         text="county")
        ...
        fig.write_image("graphImages/Appendix3_EvProportion.png")
    except:
        print("Failed to get EV_proportion graph")
