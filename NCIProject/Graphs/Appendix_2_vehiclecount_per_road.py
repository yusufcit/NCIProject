...
HeatMap(data=df_copy_traffic[['longitude','latitude','vehiclecount']].groupby(['longitude','latitude']).sum().reset_index().values.tolist(), radius=50, max_zoom=13).add_to(base_map)
