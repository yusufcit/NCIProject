...
path = "C:/Users/dotsi/Desktop/EVChargePoints3/"
...
postgresConnection = psycopg2.connect("dbname=ev_ireland user=nciadmin@nciproject password='Nciproject01?' host=nciproject.postgres.database.azure.com port=5432")
